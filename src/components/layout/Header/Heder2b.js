...
export default function HeaderTwoB({ headerObj }) {
      ...
      <img src={img} alt="" className='background-img'/>
               <div className="container-fluid">
                  <div className="row" style={{justifyContent:"center"}}>
                     <div className=' col-md-6 col-lg-6 m-0 p-0' style={{
                        position:"relative",width: "85%",
                     }}>
                        <img src={headerObj?.coverImage} alt="" className='image-right' />
                        {/* <button className='titile-upcomming'>Upcomming</button>
                        <button className='download-btn'><FontAwesomeIcon icon={faDownload}/> Download the brochure</button> */}
                     </div>
                  </div>
               </div>
      </section>
