...
function PopupProjects({text}) {
    ...
    return (
        <>
            <button type="button" className='header-Get-info' id="btnClick" data-bs-toggle="modal" data-bs-target={isDesktopModal ? "#exampleModalpop1" : "#mobileModal"}>
            {text}
            </button>
            {isDesktopModal ? (
                <DesktopModal />
