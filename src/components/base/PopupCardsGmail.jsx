...
function  PopupCardsGmail({text}) {
    ...
    return (
        ...
        <div type="button"  id="btnClick" data-bs-toggle="modal" data-bs-target={isDesktopModal ? "#exampleModalpop4" : "#mobileModal"}>
...
function DesktopModal() {
    return (
        <div className="modal fade modal-cautom myresmodal" id="exampleModalpop4" tabIndex="-1" aria-labelledby="exampleModalpop4Label" aria-hidden="true">
...
export default PopupCardsGmail
