...
function ListingCardDetailpage({projectName}) {
  const [cardData, setCardData] = useState([]);
    console.log(projectName, "<<<----------------project name here")
    ...
    // Fetch data using Axios
     axios.get(`https://salwaproperties.com/community_web/api/listing_properties/${CurrentDomain}/${projectName}?X-API-KEY=3064c564d11154da943a1fd968822b6c`)
      ...
      .catch(error => {
        ...
        console.log(cardData, "card data listing")
        console.log(`https://salwaproperties.com/community_web/api/listing_properties/${CurrentDomain}/${projectName}?X-API-KEY=3064c564d11154da943a1fd968822b6c`, "card listing apiiii")
