...
function ProdCardVillas() {
  ...
  return (
    <div className='card-flex'>
      {cardData
        .filter(card => card.type_name === "Villas") // Filter cards where status is "villas"
        .map(card => (
          <div className="card" key={card.id}>
            <img
              className="card-img-top"
            ...
            <div className="card-body">
              ...
              <p className='card-sub-title'>{card.project_usps  ? card.project_usps : "No usps Available"}</p>
